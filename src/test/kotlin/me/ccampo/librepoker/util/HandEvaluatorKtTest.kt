...
class HandEvaluatorKtTest {
  ...
  fun `evaluate`() {
    val hand = Hand(
      listOf(Card.QUEEN_OF_HEARTS, Card.QUEEN_OF_DIAMONDS, Card.ACE_OF_SPADES, Card.JACK_OF_CLUBS, Card.TEN_OF_HEARTS)
    )
  ...
  @Test
  fun `get best hand`() {
    val pocket = Pocket(listOf(Card.QUEEN_OF_HEARTS, Card.TEN_OF_SPADES))
    val board = listOf(
    ...
    val expected = Hand(
      listOf(Card.QUEEN_OF_HEARTS, Card.QUEEN_OF_CLUBS, Card.FIVE_OF_HEARTS, Card.FIVE_OF_DIAMONDS, Card.TEN_OF_SPADES)
    )
